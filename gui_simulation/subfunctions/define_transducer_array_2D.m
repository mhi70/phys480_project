...
% Last edited: 11-04-25 by Laura Cobus
%
...
%
%       - fixed array depth; array was put in too high by a factor of array.element.height/2


function [array] = define_transducer_array_2D(varargin)
...
for ind = 1:element.num
    ...
    karray.addRectElement([element.depth(ind), element_pos_y_grid(ind)], element.height, element.width, array.rot_deg); % last argument: theta
