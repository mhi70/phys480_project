%% kgrid_gui_ver6 creates user interface to set up kgrid and base medium
% New from ver3: Added reflective target

function kgrid_gui_ver6
...
% Button to start simulation. press once happy with grid
uibutton(fig, 'Text', 'START SIMU', ...
    'Position', [400, 150, 180, 30], ...
    'ButtonPushedFcn', @(btn, event) start_simulation(fig));

% Plot area
ax = uiaxes(fig, 'Position', [60, 20, 500, 120]);
