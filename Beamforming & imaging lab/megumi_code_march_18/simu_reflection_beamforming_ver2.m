...
array.element.emission  = [1:84];  % [pts]
xe = array.element.lateral(array.element.emission)*1e3; % emitter lateral [mm]
xo = ry;
xo = xo + kgrid.y_vec(1)*1000; % shift  [m]
v = medium.sound_speed_ref*1e3; %[mm/s]
